   ...
   _createClass(Section, [{
      ...
      value: function _renderItems() {
         ...
         return this.state.struct.map(function (x) {
            switch (x.type) {
               ...
               case "FSELECT":
                  return _react2.default.createElement(_foreignSelector2.default, { struct: x });
               case "FLIST":
                  return _react2.default.createElement(_foreignList2.default, { struct: x });
               default:
      ...
      value: function render() {
         return _react2.default.createElement(
            'div',
            { style: { display: 'flex', flexDirection: this.state.horizontal ? 'row' : 'column', width: '80%', justifyContent: 'flex-start', flexWrap: 'wrap', flex: 1 } },
            this._renderItems()
         );
      }
   }]);
