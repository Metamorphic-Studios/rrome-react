      ...
      value: function _render() {
         ...
         return this.state.struct.model.map(function (x) {
            if (_this3.isArray(x)) {
               ...
               return _react2.default.createElement(_section2.default, { horizontal: false, struct: _this3.mapStruct(x, _this3.state.content), onChange: _this3.handleChange.bind(_this3) });
            }
         });
      }
   }, {
